...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // >>>>>>>>>>>>>>>>>>>> game spawn logic
        // Variables to hold barrel spawn timers
        // this.lastCashSpawn = 0;
        // this.lastDeathSpawn = 0;
    ...
    spawnEntry() {
        ...
        } else if (spawnCashPot === 1 && this.gameLevel > 6 && this.cashPots.getChildren().length < 1) {
